...
export const TradeBuilderModal = () => {
  const { sortedHand, opponents, defaultTargetName, closeModal, createTrade } = useGame();
  ...
  const hasBinding = sortedHand.some((card) => card.key === "bindingContract" && !selectedHandIds.includes(card.id));
